...
public:
	...
	void loadImage(FLOAT x,FLOAT y,FLOAT width,FLOAT height,LPCSTR fileName);
...
public:
	...
	bool loadImage(BinaryStream* s,FLOAT x,FLOAT y,FLOAT width,FLOAT height,LPCSTR fileName);
